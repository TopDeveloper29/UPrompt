# [Back](https://github.com/TopDeveloper29/UPrompt/blob/Prod/README.md) | View
...
```
## [Top](https://github.com/TopDeveloper29/UPrompt/blob/Prod/Documentation/View.md#section-in-the-page) | ViewInput
...
```
## [Top](https://github.com/TopDeveloper29/UPrompt/blob/Prod/Documentation/View.md#section-in-the-page) | ViewAction
...
## [Top](https://github.com/TopDeveloper29/UPrompt/blob/Prod/Documentation/View.md#section-in-the-page) | Html
Creating a custom element requires a basic knowledge of HTML/CSS. To make it work with UPrompt, you will need more details about how built-in XML elements are converted to HTML elements and how UPrompt retrieves information from them. To start creating your own HTML element, refer to this page: [Learn how to create HTML elements for UPprompt](https://github.com/TopDeveloper29/UPrompt/blob/Prod/Documentation/Html.md)
